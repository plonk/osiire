...
class Item
  ITEMS = [
    ...
    [:herb, "すばやさの種", nil, "行動速度が二倍になる。"],
    [:herb, "目薬草", nil, "ワナが見えるようになる。"],
    [:herb, "毒草", nil, "ダメージを受け、ちからが3下がる。敵は鈍足に。"],
    [:herb, "目つぶし草", nil, "目が見えなくなる。"],
    [:herb, "まどわし草", nil, "敵に当てると逃げていく。"],
    [:herb, "混乱草", nil, "混乱してしまう。投げて使おう。"],
    [:herb, "睡眠草", nil, "眠ってしまう。投げて使おう。"],
    [:herb, "ワープ草", nil, "フロアの別の場所にワープする。"],
    [:herb, "火炎草", nil, "口から火をはく。敵に投げても使える。"],
    [:scroll, "やりなおしの巻物", nil, "1階に引き戻される。"],
