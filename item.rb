...
[{:type=>:weapon, :name=>"鍛えた木刀", :number=>2, :nslots=>1},
 ...
 {:type=>:scroll, :name=>"パーティールームの巻物"},
 {:type=>:scroll, :name=>"混乱の巻物"},
 ...
 {:type=>:staff, :name=>"ばしがえの杖", :desc=>"敵と位置を入れ替える。"},
 {:type=>:staff, :name=>"いちしのの杖", :desc=>"敵を階段上にワープさせる。"},
 {:type=>:staff, :name=>"ふきとばの杖", :desc=>"敵をふきとばす。"},
 {:type=>:staff, :name=>"かなしばの杖", :desc=>"敵がかなしばり状態になる。"},
